@tool
@icon("res://assets/2d/icons/level_bounds.svg")
class_name LevelBounds extends Node2D

@export_range(640,10000, 32 , "suffix:px") var width : int = 640 : set = _on_width_changed
@export_range(360,10000, 32 , "suffix:px") var height : int = 360 :  set = _on_height_changed
